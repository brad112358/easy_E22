...
The tightly integrated mechanical and electrical design give this node
...
However note the way part groups compliment
each other, specfically, the hinged antenna, the right angle SMA
connector, and the tiny switch.
Also, the pin layout of the NRF52840 module was chosen to match
...
- Two battery voltage sensing divider resistors
    ...
    Most any pair of same value, axial-lead resistors will work to
...
This could help keep room between pin 12 the NRF52 pad where
...
(1 Watt) output should actually produce about 33 dBm (2 Watts) output.
